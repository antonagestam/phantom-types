...
class TestShippedTypesImplementsSchema:
    def test_interval_open_implements_schema(self):
        assert TestModel.schema()["properties"]["open"] == {
            "minimum": 0,
            "maximum": 100,
    ...
    def test_interval_closed_implements_schema(self):
        assert TestModel.schema()["properties"]["closed"] == {
    ...
    def test_interval_open_closed_implements_schema(self):
        assert TestModel.schema()["properties"]["open_closed"] == {
    ...
    def test_interval_closed_open_implements_schema(self):
        assert TestModel.schema()["properties"]["closed_open"] == {
    ...
    def test_interval_negative_int_implements_schema(self):
        assert TestModel.schema()["properties"]["negative_int"] == {
            "title": "NegativeInt",
            "maximum": 0,
    ...
    def test_interval_natural_implements_schema(self):
        assert TestModel.schema()["properties"]["natural"] == {
            "title": "Natural",
            "description": "An integer value in the inclusive range (0, ∞).",
            "minimum": 0,
            "type": "integer",
    ...
    def test_interval_portion_implements_schema(self):
        assert TestModel.schema()["properties"]["portion"] == {
            "title": "Portion",
    ...
    def test_tz_aware_implements_schema(self):
        assert TestModel.schema()["properties"]["tz_aware"] == {
            "title": "TZAware",
    ...
    def test_tz_naive_implements_schema(self):
        assert TestModel.schema()["properties"]["tz_naive"] == {
            "title": "TZNaive",
    ...
    def test_re_match_implements_schema(self):
        assert TestModel.schema()["properties"]["match"] == {
            "title": "MatchType",
            "description": (
    ...
    def test_re_full_match_implements_schema(self):
        assert TestModel.schema()["properties"]["full_match"] == {
            "title": "FullMatchType",
    ...
    def test_sized_non_empty_implements_schema(self):
        assert TestModel.schema()["properties"]["non_empty"] == {
            "title": "NonEmpty",
            "type": "array",
    ...
    def test_sized_empty_implements_schema(self):
        assert TestModel.schema()["properties"]["empty"] == {
            "title": "Empty",
            "type": "array",
